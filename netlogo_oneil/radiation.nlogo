...
to cycle
  ...
  [ifelse ( glucose / count turtles-here ) < critical-glucose-level [ die ]
    [ifelse ( glucose / count turtles-here ) > quiescent-glucose-level and ( count turtles-here
      + count turtles-on neighbors ) < critical-neighbors
      [absorb-glucose
        repair-radiation
        set age 0
        set energy 0
  ...
  [ifelse age > 13 [die]
    [ifelse ( glucose / count turtles-here ) < critical-glucose-level [die]
      [ifelse breed = Healthycells and ( glucose / count turtles-here ) < quiescent-glucose-level
        [absorb-glucose
          repair-radiation
          set age 0
          set energy 0
...
to divide
  ...
  [
    ...
    [let mutate (radiation * mutation-probability)
      ifelse random-float 1 > mutate ;hatch cancer cell w probability based on radiation exposure
      [hatch-Healthycells 1
        [downhill turtle-count
          set age 0
          set energy 0
...
to radiate
  ...
  [
    ...
    ;The idea is that if the random number generated is lower, it is less likely to be greater than the survival
    ...
    [if (ticks + start-time) mod 24 = 0
      [let neighbors-radiated count turtles-on patches with [pcolor = yellow and distance
        ...
        [set #bystander-deaths (#bystander-deaths + 1)
          die]
        set radiation (radiation + bystander-dose)] ;gives indirectly radiated cells ability to mutate
...
"Mitosis" 1.0 0 -2674135 true "" ""
"G2" 1.0 0 -955883 true "" ""
"Synthesis" 1.0 0 -6459832 true "" ""
...
PENS
"G1" 1.0 0 -7500403 true "" ""
"Synthesis" 1.0 0 -2674135 true "" ""
"G2" 1.0 0 -955883 true "" ""
"Mitosis" 1.0 0 -6459832 true "" ""
